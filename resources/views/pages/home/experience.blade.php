<section class="relative pt-20 pb-40 overflow-hidden bg-gradient-to-b via-slate-50 to-white sm:pt-24 lg:pt-32 lg:pb-64 dark:bg-gray-800">
    <!-- Container -->
    <div class="max-w-screen-xl px-5 mx-auto sm:px-6 lg:px-8">
        <!-- Section header -->
        <div class="grid items-center max-w-xl gap-6 mx-auto lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-16">
            <div>
                <h2 class="text-4xl font-semibold font-display text-slate-900 sm:text-5xl dark:text-white">
                    ...
                    <span class="relative whitespace-nowrap">
                        ...
                        <span class="relative dark:text-sky-700">tout en un</span>
                    </span>
                    pour vos projets
                </h2>
            </div>
            <div>
                <p class="text-lg leading-8 text-slate-700 dark:text-white">
                    Découvrez l'avantage d'une solution de projet tout compris, où l'excellence, la rapidité et la
                    réactivité convergent pour garantir des résultats de la plus haute qualité.
                </p>
            </div>
        </div>

        <!-- Content -->
        <div class="grid max-w-xl mx-auto mt-16 gap-14 lg:mx-0 lg:mt-24 lg:max-w-none lg:grid-cols-12 lg:gap-7">
            <!-- Features with icons -->
            <div class="max-w-lg lg:col-span-4">
                <ul class="relative">
                    <!-- Feature 1 -->
                    <li>
                        <div class="relative pb-24 lg:pb-20">
                            <span class="absolute -ml-px border border-dashed top-24 left-10 bottom-4 border-slate-300"
                                aria-hidden="true"></span>
                            <div class="relative flex space-x-7">
                                <div>
                                    <span
                                        class="flex items-center justify-center w-20 h-20 rounded-full shadow-lg bg-slate-900 dark:bg-sky-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" class="w-6 h-6 text-sky-50">
                                            <g clip-path="url(#clip0_112_3)">
                                                <path d="M3.5 19.5V23.5H21.5V19.5" stroke="currentColor"
                                ...
                                <div>
                                    <h3 class="text-xl font-medium font-display dark:text-sky-700">
                                        Excellence
                                    </h3>
                                    <p class="mt-2.5 text-base text-slate-700 dark:text-white">
                                        Je suis fier de bien faire les choses. Tout le travail du client est fait avec
                    ...
                    <li>
                        <div class="relative pb-24 lg:pb-20">
                            <span class="absolute -ml-px border border-dashed top-24 left-10 bottom-4 border-slate-300 dark:bg-sky-700"
                                aria-hidden="true"></span>
                            <div class="relative flex space-x-7">
                                <div>
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <g clip-path="url(#clip0_112_53)">
                                                <path d="M3.5 1.5H21.5" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M3.5 23.5H21.5" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                ...
                                <div>
                                    <h3 class="text-xl font-medium font-display text-slate-900 dark:text-sky-700">
                                        Rapidité
                                    </h3>
                                    <p class="mt-2.5 text-base text-slate-700 dark:text-white">
                                        J'aime travailler dur et vite. Je sais à quel point les délais sont importants
                                        pour mes clients.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="relative">
                            <div class="relative flex space-x-7">
                                    ...
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <g clip-path="url(#clip0_112_46)">
                                                <path d="M23.5 1.5H11.5V11.5L16.5 7.5H23.5V1.5Z" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                ...
                                <div>
                                    ...
                                    <p class="mt-2.5 text-base text-slate-700 dark:text-white">
                                        Vous pouvez compter sur moi pour être réactif et clair lorsque nous travaillons
                                        ensemble.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="absolute hidden gap-6 -bottom-36 -right-8 lg:flex">
                        <svg xmlns="http://www.w3.org/2000/svg" width="81" height="83" viewBox="0 0 81 83"
                            fill="none" class="relative w-20 h-auto -top-2 text-slate-600 dark:text-sky-700">
                        ...
                        <span
                            class="inline-block max-w-[220px] -rotate-12 transform font-writing text-2xl tracking-wide text-slate-600 dark:text-sky-700">
            ...
            <div class="lg:col-span-8 lg:pl-8 xl:pl-24">
                <div class="relative w-full aspect-w-3 aspect-h-2">
                    <img class="object-cover object-center w-full h-full rounded-3xl"
                        src="storage/images/experience-image.jpg" alt=""
                    ...
                    <div>
                        <div
                            ...
                            <a href="storage/images/moncv.pdf" download>
                                ...
                                <!-- Download button -->
                                <button
                                    class="relative inline-flex items-center justify-center w-12 h-12 duration-200 -translate-x-1/2 -translate-y-1/2 rounded-full top-1/2 left-1/2 bg-slate-900 hover:bg-slate-800 lg:h-20 lg:w-20">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                        viewBox="0 0 32 32" class="w-5 h-5 text-white lg:h-7 lg:w-7">
                                        <g stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2"
                                            fill="Lne" stroke="currentColor">
                                            <line x1="16" y1="2" x2="16" y2="23"
                                                stroke="currentColor"></line>
                                            <polyline points="9 16 16 23 23 16" stroke="currentColor"></polyline>
                        ...
                        <!-- Stats -->
                        <div
                            class="absolute bottom-0 grid grid-cols-2 gap-5 px-6 py-8 text-center translate-x-1/2 right-1/2 w-max translate-y-3/4 rounded-2xl bg-sky-700/90 backdrop-blur-sm sm:translate-y-1/2 sm:gap-12 sm:p-10 lg:right-20 lg:translate-x-0">
                            <div class="flex flex-col gap-1">
                                <dt class="text-sm font-semibold leading-6 text-sky-50">
                                    Années d'expérience
                                </dt>
                                <dd class="order-first text-3xl font-extrabold text-white sm:text-4xl">
                                    2
                                </dd>
                            </div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="82" height="84" viewBox="0 0 82 84"
                            class="absolute w-20 h-auto -top-8 -right-8 text-slate-700">
                            <g clip-path="url(#clip0_102_2463)">
                                <path
                                    d="M41.5816 1.21606C39.7862 5.82482 40.3852 10.0977 40.5593 14.9633C40.7854 21.2812 40.9774 27.5593 41.4363 33.8661"
                                    stroke="currentColor" stroke-width="1.90596" stroke-linecap="round" />
                                <path
                                ...
                                <path
                                    ...
                                    stroke="currentColor" stroke-width="1.90596" stroke-linecap="round" />
                                <path d="M47.2629 40.0959C58.4139 39.3819 69.3895 37.5305 80.4472 35.9965"
                                    stroke="currentColor" stroke-width="1.90596" stroke-linecap="round" />
                                <path d="M49.3429 34.6508L52.917 28.1667" stroke="currentColor"
                                    stroke-width="1.90596" stroke-linecap="round" />
                                <path d="M32.9786 50.3504L28.6387 54.6391" stroke="currentColor"
                                    stroke-width="1.90596" stroke-linecap="round" />
                                <path d="M52.6361 48.6656L56.9506 51.5758" stroke="currentColor"
                                    stroke-width="1.90596" stroke-linecap="round" />
                                <path d="M31.549 30.8471C26.8741 29.4323 22.7143 27.3543 18.2738 25.3586"
                                    stroke="currentColor" stroke-width="1.90596" stroke-linecap="round" />
                            </g>
                            <defs>
