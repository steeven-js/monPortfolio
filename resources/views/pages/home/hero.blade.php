        ...
        <div class="flex flex-col items-center max-w-2xl mx-auto lg:items-start">
            <h1
                ...
                <span class="relative whitespace-nowrap">
                    ...
                    <span class="relative dark:text-sky-700">Transformez</span>
                </span>
                vos idées en réalités
            </h1>
            <p class="mt-6 text-lg leading-8 text-center text-slate-700 lg:text-left dark:text-white">
                Je suis un développeur passionné, un entrepreneur et un passionné de technologie générale vivant en
                Martinique. J'ai travaillé avec des centaines de startups pour les aider à développer leurs idées en
            ...
            <div class="flex flex-wrap items-center justify-center mt-10 gap-y-6 gap-x-10 lg:justify-start">
                ...
                <div class="flex gap-3 sm:gap-4">
                    ...
                    <a class="flex items-center justify-center duration-200 border rounded-full h-11 w-11 border-slate-200 hover:bg-slate-50"
                        href="https://github.com/steeven-js" aria-label="Follow on Github">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="w-4 h-4 transition fill-slate-600 group-hover:fill-slate-700"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                    </a>

                    <!-- Link 2 -->
                    <a class="flex items-center justify-center duration-200 border rounded-full h-11 w-11 border-slate-200 hover:bg-slate-50"
                        href="https://www.linkedin.com/in/steeven-jacques-1337a9238/" aria-label="Follow on Twitter">
            ...
            <div class="relative aspect-h-5 aspect-w-4 rounded-2xl bg-slate-50">
                ...
                <div>
                    ...
                    <div
                        ...
                        <span
                            class="inline-block transform font-writing text-2xl tracking-wide text-slate-600 md:rotate-[16deg] lg:translate-x-6 lg:rotate-[-18deg] 2xl:rotate-12 dark:text-sky-700">
                            Bonjour, je m'appelle <br> Steeven!
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="103" height="102" viewBox="0 0 103 102"
                            fill="none"
                            class="h-auto w-28 text-slate-600 md:-translate-x-1/2 md:-translate-y-6 md:rotate-0 lg:translate-x-3/4 lg:-translate-y-3 lg:rotate-12 lg:-scale-x-100 2xl:-translate-x-1/2 2xl:-translate-y-6 2xl:rotate-0 2xl:scale-x-100 dark:text-sky-700">
                            <g>
                                <path
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <img src="storage/images/logos/icons/figma.png" alt="" class="w-4 h-auto" />3
                            years of
                            experience
                        </div>
                        ...
                        <div
                            ...
                            <img src="storage/images/logos/icons/sketch.png" alt="" class="w-auto h-6" />5
                            years
                            of experience
                        </div>
                        ...
                        <div
                            ...
                            <img src="storage/images/logos/icons/tailwindcss.png" alt=""
                                class="h-auto w-7" />
