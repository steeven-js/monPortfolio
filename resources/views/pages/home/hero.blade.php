<section class="relative py-20 overflow-hidden lg:py-24 dark:bg-gray-800">
    ...
    <svg width="1728" height="894" viewBox="0 0 1728 894" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <g clip-path="url(#clip0_8_95)">
            <g opacity="0.6" filter="url(#filter0_f_8_95)">
                <path d="M201.4 582.997H330V342.155L23 501.52L201.4 582.997Z" fill="#60A5FA" fill-opacity="0.45" />
                <path d="M330 342.155V284H90H-70L23 501.52L330 342.155Z" fill="#7DD3FC" fill-opacity="0.8" />
                <path d="M-70 582.997H201.4L23 501.52L-70 284V582.997Z" fill="#F0FDFA" fill-opacity="0.5" />
            </g>
        </g>
        <defs>
            <filter id="filter0_f_8_95" x="-370" y="-16" width="1000" height="898.997"
    ...
    <div
        ...
        <div class="flex flex-col items-center max-w-2xl mx-auto lg:items-start">
            <h1 class="text-5xl font-semibold text-center font-display text-slate-900 sm:text-6xl lg:text-left dark:text-white">
                <span class="relative whitespace-nowrap">
                    ...
                    <span class="relative">Transformez</span>
                </span>
                vos idées en réalités
            </h1>
            <p class="mt-6 text-lg leading-8 text-center text-slate-700 lg:text-left dark:text-white">
                Je suis un développeur passionné, un entrepreneur et un passionné de technologie générale vivant en Martinique. J'ai travaillé avec des centaines de startups pour les aider à développer leurs idées en entreprises rentables.
            </p>
            <div class="flex flex-wrap items-center justify-center mt-10 gap-y-6 gap-x-10 lg:justify-start">
                <a href="#"
                    class="h-11 bg-slate-900 text-white hover:bg-sky-800 inline-flex items-center rounded-full gap-2.5 justify-center px-7 py-3 text-md font-semibold leading-none outline-offset-2 transition-all duration-200 ease-in-out active:transition-none">Book
                    a call with me</a>

                <!-- Social links -->
                <div class="flex gap-3 sm:gap-4">
                    <!-- Link 1-->
                    <a class="flex items-center justify-center duration-200 border rounded-full h-11 w-11 border-slate-200 hover:bg-slate-50"
                        href="https://dribbble.com" aria-label="Follow on Dribbble">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor" class="w-4 h-4 transition fill-slate-600 group-hover:fill-slate-700">
                            <g>
                    ...
                    <!-- Link 2 -->
                    <a class="flex items-center justify-center duration-200 border rounded-full h-11 w-11 border-slate-200 hover:bg-slate-50"
                        href="https://instagram.com" aria-label="Follow on Instagram">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor" class="w-4 h-4 transition fill-slate-600 group-hover:fill-slate-700">
                            <g>
                                <path
                    ...
                    <!-- Link 3 -->
                    <a class="flex items-center justify-center duration-200 border rounded-full h-11 w-11 border-slate-200 hover:bg-slate-50"
                        href="https://twitter.com" aria-label="Follow on Twitter">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="currentColor" class="w-4 h-4 transition fill-slate-600 group-hover:fill-slate-700">
                            <g>
                                <path
        ...
        <div class="w-full max-w-lg mx-auto lg:mr-0">
            <div class="relative aspect-h-5 aspect-w-4 rounded-2xl bg-slate-50">
                <img class="object-cover object-center w-full h-full rounded-2xl" src="storage/images/hero-portrait.jpg"
                    alt="" sizes="(min-width: 552px) 32rem, calc(100vw - 40px)" />
                <div>
                    <!-- Floating handwritten text with arrow -->
                    <div
                        class="absolute hidden w-max md:top-16 md:left-full md:block lg:-top-8 lg:-left-28 2xl:top-16 2xl:left-[80%]">
                        <span
                            class="inline-block transform font-writing text-2xl tracking-wide text-slate-600 md:rotate-[16deg] lg:translate-x-6 lg:rotate-[-18deg] 2xl:rotate-12">
                            Bonjour, je m'appelle <br> Steeven!
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="103" height="102" viewBox="0 0 103 102"
                            fill="none"
                            class="h-auto w-28 text-slate-600 md:-translate-x-1/2 md:-translate-y-6 md:rotate-0 lg:translate-x-3/4 lg:-translate-y-3 lg:rotate-12 lg:-scale-x-100 2xl:-translate-x-1/2 2xl:-translate-y-6 2xl:rotate-0 2xl:scale-x-100">
                            <g>
                                <path
                    ...
                    <div>
                        ...
                        <div
                            class="absolute right-12 -top-6 inline-flex h-12 w-max items-center justify-center gap-3.5 rounded-2xl bg-white/90 px-8 text-sm font-semibold text-slate-700 shadow-lg shadow-sky-100/50 ring-1 ring-slate-900/5 backdrop-blur-md md:-left-28 md:top-14 lg:left-44 lg:-top-6 lg:px-10 2xl:-left-48 2xl:top-14">
                            <img src="storage/images/logos/icons/figma.png" alt="" class="w-4 h-auto" />4 years of
                            experience
                        </div>
                        ...
                        <div
                            ...
                            <img src="storage/images/logos/icons/sketch.png" alt="" class="w-auto h-6" />5 years
                            of experience
                        </div>
                        ...
                        <div
                            ...
                            <img src="storage/images/logos/icons/tailwindcss.png" alt="" class="h-auto w-7" />
