<section class="relative flex justify-center pt-16 bg-white gap-x-12 overflow-x-clip sm:gap-x-16 lg:pt-12 lg:pb-14">
    <!-- Fading edges -->
    <div class="absolute inset-y-0 left-0 w-64 h-full bg-gradient-to-r from-white/50 to-white/0"></div>
    <div class="absolute inset-y-0 right-0 w-64 h-full bg-gradient-to-l from-white/50 to-white/0"></div>
    ...
    <div
        ...
        <svg viewBox="0 0 107 62" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="relative -top-4 -right-1 h-auto w-[68px] rotate-[160deg] transform text-slate-600 lg:w-20 lg:rotate-[30deg] lg:-scale-x-100">
            <path
        ...
        <span
            class="inline-block w-48 rotate-6 transform font-writing text-[22px] tracking-wide text-slate-600 lg:text-2xl">
    ...
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-8">
        <img src="storage/images/logos/icons/sketch.png" alt="Sketch" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>

    <!-- Icon 7 -->
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-0">
        <img src="storage/images/logos/icons/rails.png" alt="Ruby on Rails" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>

    <!-- Icon 8 -->
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-8">
        <img src="storage/images/logos/icons/netlify.png" alt="Netlify" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>

    <!-- Icon 9 -->
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-16">
        <img src="storage/images/logos/icons/python.png" alt="Python" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>

    <!-- Icon 10 -->
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-24">
        <img src="storage/images/logos/icons/postgresql.png" alt="postgresql" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>
    ...
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-8">
        <img src="storage/images/logos/icons/c.png" alt="C programming language" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>

    <!-- Icon 13 -->
    <div
        class="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-slate-50/90 shadow-sm shadow-sky-100 ring-1 ring-slate-100 sm:h-[88px] sm:w-[88px] mt-0">
        <img src="storage/images/logos/icons/ruby.png" alt="Ruby programming language" class="w-8 h-auto shrink-0 sm:w-10" />
    </div>
</section>
