    ...
    <section class="relative overflow-hidden">
        ...
        <div class="max-w-screen-xl mx-auto">
            <div class="lg:columns-2 lg:gap-8">
                <!-- Content -->
                <div
                    class="relative bg-slate-50 py-16 px-5 sm:py-24 sm:px-6 lg:col-span-6 lg:rounded-br-[64px] lg:px-8 lg:pt-32 2xl:pl-0">
                    <!-- Background to cover left portion of large screens -->
                    <div class="absolute inset-y-0 left-0 hidden w-full -translate-x-full bg-slate-50 lg:block"></div>

                    <div class="relative max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
                        <h2
                            class="font-display text-4xl font-semibold leading-tight text-slate-900 sm:text-5xl sm:leading-tight lg:text-[40px] lg:leading-tight xl:text-5xl xl:leading-tight">
                        ...
                        <div
                            ...
                            <span class="inline-block w-52 max-w-[220px] transform sm:w-auto sm:-rotate-6">
                                You can <span class="text-sky-700">reach me</span> at the
                                following
                            </span>
                    ...
                    <div class="max-w-lg mx-auto lg:mr-0">
                        ...
                        <form action="#" method="POST" class="mt-10">
                            <div class="space-y-7">
                                ...
                                <fieldset>
                                    <legend class="block font-medium leading-6 text-md text-slate-900">
                                        Expected services
                                    </legend>
                                    <div class="mt-4 space-y-3">
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 text-sm leading-6">
                                                <label for="web-development" class="text-slate-700">
                                                    Web development
                                                </label>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm leading-6">
                                                    <label for="web-design" class="text-slate-700">
                                                        Web design
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm leading-6">
                                                    <label for="consulting" class="text-slate-700">
                                                        Consulting
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm leading-6">
                                                    <label for="other" class="text-slate-700">
                                                        Other
                                                    </label>
                                                </div>
                                            </div>
